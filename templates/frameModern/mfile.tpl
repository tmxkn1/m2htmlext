...
<div class="box">{H1LINE}</div>

<h2><a name="_synopsis"></a>SYNOPSIS <a href="#_top"><img alt="^" border="0" src="{MASTERPATH}up.png"></a></h2>
<div class="box">{SYNOPSIS} <!-- BEGIN script --> This is a script file. <!-- END script --> </div>
...
<ul style="list-style-image:url({MASTERPATH}icon_mfunc.png)">
